...
if read_the_docs_build:
    ...
    subprocess.check_call(
        "cmake -Dtest-gha-cookiecutter_BUILD_DOCS=ON -Dtest-gha-cookiecutter_BUILD_TESTING=OFF -Dtest-gha-cookiecutter_BUILD_PYTHON=OFF ../..".split(),
        cwd=builddir,
    )
    subprocess.check_call(
        "cmake --build . --target test-gha-cookiecutter-doxygen".split(), cwd=builddir
    )
    breathe_projects["test-gha-cookiecutter"] = os.path.join(builddir, "doc", "xml")
